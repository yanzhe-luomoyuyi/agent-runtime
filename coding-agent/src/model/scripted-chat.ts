/**
 * Deterministic scripted ChatModelProvider — canned tool-call / final-answer
 * turns, no network. Shared by offline tests and the `eval` CLI scenarios.
 */
...
export type ScriptStep = ChatResponse | ((req: ChatModelRequest, turn: number) => ChatResponse);
